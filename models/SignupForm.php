...
class SignupForm extends User
{
    ...
    public function rules()
    {
        return [
            ['username', 'trim'],
            ['username', 'required'],
            ['username', 'unique', 'targetClass' => '\app\models\User', 'message' => Yii::t('site', 'This username has already been taken.')],
            ['username', 'string', 'min' => 4, 'max' => 255],
            ['email', 'trim'],
            ['email', 'required'],
            ['email', 'email'],
            ['email', 'string', 'max' => 255],
            ['email', 'unique', 'targetClass' => '\app\models\User', 'message' => Yii::t('site', 'This email address has already been taken.')],
    ...
    public function signup()
    {
        ...
        $user->active = User::ACTIVE_SUCCESS;

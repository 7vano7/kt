...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            ['username', 'unique', 'filter'=>['!=', 'id', $this->id], 'targetClass' => '\app\models\User', 'message' =>
                Yii::t('users', 'This username has already been taken.')],
            ...
            ['email', 'unique', 'filter'=>['!=', 'id', $this->id], 'targetClass' => '\app\models\User', 'message' =>
                Yii::t('users', 'This email address has already been taken.')],
            ...
            ['active', 'default', 'value' => self::ACTIVE_SUCCESS],
